...
static PyObject *impl_urllib3$util$wait$$$function__1_select_wait_for_socket(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_0f6db5c6528e8abedf2e39dc223868aa = MAKE_FUNCTION_FRAME(tstate, codeobj_0f6db5c6528e8abedf2e39dc223868aa, module_urllib3$util$wait, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_0f6db5c6528e8abedf2e39dc223868aa);
...
static PyObject *impl_urllib3$util$wait$$$function__2_poll_wait_for_socket(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_9672e6cdb76cb6fda6d382dbaf0ec301)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_9672e6cdb76cb6fda6d382dbaf0ec301 = MAKE_FUNCTION_FRAME(tstate, codeobj_9672e6cdb76cb6fda6d382dbaf0ec301, module_urllib3$util$wait, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_9672e6cdb76cb6fda6d382dbaf0ec301);
    ...
    branch_yes_2:;
    {
        ...
        tmp_ibitor_expr_right_1 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_1, mod_consts[8]);
    ...
    branch_yes_3:;
    {
        ...
        tmp_ibitor_expr_right_2 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_2, mod_consts[9]);
    ...
    branch_no_3:;
    {
        ...
        tmp_assign_source_4 = CALL_METHOD_NO_ARGS(tstate, tmp_called_instance_1, mod_consts[10]);
        if (tmp_assign_source_4 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
...
static PyObject *impl_urllib3$util$wait$$$function__2_poll_wait_for_socket$$$function__1_do_poll(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_d2a482a1d2f01941fd060ef3604ddb08)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_d2a482a1d2f01941fd060ef3604ddb08 = MAKE_FUNCTION_FRAME(tstate, codeobj_d2a482a1d2f01941fd060ef3604ddb08, module_urllib3$util$wait, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_d2a482a1d2f01941fd060ef3604ddb08);
...
static PyObject *impl_urllib3$util$wait$$$function__3__have_working_poll(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_4a45f2df54bfa6482704556e39a8ca5a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_4a45f2df54bfa6482704556e39a8ca5a = MAKE_FUNCTION_FRAME(tstate, codeobj_4a45f2df54bfa6482704556e39a8ca5a, module_urllib3$util$wait, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_4a45f2df54bfa6482704556e39a8ca5a);
...
static PyObject *impl_urllib3$util$wait$$$function__4_wait_for_socket(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_363f9c1a19633a888f7f5f03d7de9a2b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_363f9c1a19633a888f7f5f03d7de9a2b = MAKE_FUNCTION_FRAME(tstate, codeobj_363f9c1a19633a888f7f5f03d7de9a2b, module_urllib3$util$wait, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_363f9c1a19633a888f7f5f03d7de9a2b);
    ...
    branch_yes_2:;
    {
        ...
        if (unlikely(tmp_assign_source_2 == NULL)) {
            tmp_assign_source_2 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[22]);
        }
...
static PyObject *impl_urllib3$util$wait$$$function__5_wait_for_read(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_9577b6e0c8e9f06c3cc3f676b841b739)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_9577b6e0c8e9f06c3cc3f676b841b739 = MAKE_FUNCTION_FRAME(tstate, codeobj_9577b6e0c8e9f06c3cc3f676b841b739, module_urllib3$util$wait, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_9577b6e0c8e9f06c3cc3f676b841b739);
    ...
    // Framed code:
    {
        ...
        frame_9577b6e0c8e9f06c3cc3f676b841b739->m_frame.f_lineno = 117;
        {
            ...
            tmp_return_value = CALL_FUNCTION_WITH_ARGS1_KWSPLIT(tstate, tmp_called_value_1, args, kw_values, mod_consts[23]);
        }
...
static PyObject *impl_urllib3$util$wait$$$function__6_wait_for_write(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_b2207dbf5ec31cfe1aa2d3d095976993)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b2207dbf5ec31cfe1aa2d3d095976993 = MAKE_FUNCTION_FRAME(tstate, codeobj_b2207dbf5ec31cfe1aa2d3d095976993, module_urllib3$util$wait, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_b2207dbf5ec31cfe1aa2d3d095976993);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_f418116c49a36e131e5284b2a5338694);
