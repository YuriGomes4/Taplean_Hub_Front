...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("requests._internal_utils"));
...
static PyObject *impl_requests$_internal_utils$$$function__1_to_native_string(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_941f7bf16d753db85a0f2b095de5b96a = MAKE_FUNCTION_FRAME(tstate, codeobj_941f7bf16d753db85a0f2b095de5b96a, module_requests$_internal_utils, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_941f7bf16d753db85a0f2b095de5b96a);
...
static PyObject *impl_requests$_internal_utils$$$function__2_unicode_is_ascii(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_974d48dfd0603dfeca0884e7453dfd51)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_974d48dfd0603dfeca0884e7453dfd51 = MAKE_FUNCTION_FRAME(tstate, codeobj_974d48dfd0603dfeca0884e7453dfd51, module_requests$_internal_utils, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_974d48dfd0603dfeca0884e7453dfd51);
...
PyObject *modulecode_requests$_internal_utils(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_3580093ce57f51f70ad9e71f982967e8);
