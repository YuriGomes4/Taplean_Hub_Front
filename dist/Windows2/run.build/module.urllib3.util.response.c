...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("urllib3.util.response"));
...
static PyObject *impl_urllib3$util$response$$$function__1_is_fp_closed(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_889131d6c8f183f7df105c5d92165997 = MAKE_FUNCTION_FRAME(tstate, codeobj_889131d6c8f183f7df105c5d92165997, module_urllib3$util$response, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_889131d6c8f183f7df105c5d92165997);
...
static PyObject *impl_urllib3$util$response$$$function__2_assert_header_parsing(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_1b06f8c073b9484e832accb60c34896f)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_1b06f8c073b9484e832accb60c34896f = MAKE_FUNCTION_FRAME(tstate, codeobj_1b06f8c073b9484e832accb60c34896f, module_urllib3$util$response, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_1b06f8c073b9484e832accb60c34896f);
    ...
    branch_yes_2:;
    {
        ...
        tmp_assign_source_2 = CALL_METHOD_NO_ARGS(tstate, tmp_called_instance_2, mod_consts[11]);
    ...
    branch_yes_5:;
    {
        ...
        frame_1b06f8c073b9484e832accb60c34896f->m_frame.f_lineno = 88;
        {
            ...
            tmp_raise_type_2 = CALL_FUNCTION_WITH_NO_ARGS_KWSPLIT(tstate, tmp_called_value_1, kw_values, mod_consts[17]);
        }
...
static PyObject *impl_urllib3$util$response$$$function__3_is_response_to_head(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_a6a42ee8c7b35eb837749f9995896720)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_a6a42ee8c7b35eb837749f9995896720 = MAKE_FUNCTION_FRAME(tstate, codeobj_a6a42ee8c7b35eb837749f9995896720, module_urllib3$util$response, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_a6a42ee8c7b35eb837749f9995896720);
...
PyObject *modulecode_urllib3$util$response(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_519f40c329c0f16fbdba4d1e535a8855);
